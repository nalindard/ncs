...
<template>
    <div class="bg-purple-400 w-full h-full rounded-2xl shadow-lg overflow-hidden relative">
        <!-- Blured background -->
        <span
            class="
        ...
        <div class="absolute top-0 left-0 w-full h-full bg-opacity-25 bg-purple-400 p-4 flex justify-start items-end">
            <div class="flex flex-col items-leftw-full h-full">
                ...
                <div class="mt-1">
                    <h3
                        class="font-semibold text-purple-900 bg-purple-400 bg-opacity-40 px-2 rounded-full">
                        Maria Wanner</h3>
                    <p class="text-sm font-medium text-purple-100 bg-purple-700 bg-opacity-40 px-2 rounded-full mt-1">
                        maria@gmail.com</p>
                </div>
            </div>
        </div>
